...
<?
while(list($IP, $StartTime, $EndTime, $UserIDs, $UserStartTimes, $UserEndTimes, $Usernames, $UsersEnabled, $UsersDonor, $UsersWarned) = $DB->next_record()) {
	$HasDupe = false;
...
?>
		<tr class="rowa">
			<td><?=$IP?> (<?//=old_geoip($IP)?>)<br /><?=get_host($IP)?></td>
