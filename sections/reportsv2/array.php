		...
		'1' => array( //Music Resolves
			...
			'transcode' => array(
				...
				'resolve_options' => array(
					...
					'warn' => '2',
					'delete' => '1',
					'pm' => 'No transcodes or re-encodes of lossy releases are acceptable here.'
				)
			),
			'low' => array(
				'priority' => '4',
			...
			'tags_lots' => array(
				...
				'resolve_options' => array(
					...
					'warn' => '1',
					'delete' => '1',
					'pm' => 'Properly tag your music files. Certain meta tags (e.g. ID3, Vorbis, Apev2) are required on all music uploads. The required tags are: Artist, Album, Title and Track Number.'
				)
			),
			'wrong_format' => array(
				'priority' => '705',
