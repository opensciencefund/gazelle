...
<?
$DB->query("SELECT ID, Label, Artists, ExcludeVA, Tags, ReleaseTypes, Categories, Formats, Encodings, Media, FromYear, ToYear FROM users_notify_filters WHERE UserID='$LoggedUser[ID]' UNION ALL SELECT NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL");
$i = 0;
...
<?	} elseif($NumFilters>0) { ?>
			<h3>
				...
				<?=display_str($N['Label'])?>
				<a href="user.php?action=notify_delete&amp;id=<?=$N['ID']?>">(Delete)</a>
			</h3>
<?	} ?>
