<?
enforce_login();
show_header("Requests");
?>
<h1>Down for maintenence</h1>
<?
show_footer();
die();
...
if(!isset($_REQUEST['action'])) {
	...
	switch($_REQUEST['action']){
		case 'edit':
		case 'new':
			include(SERVER_ROOT.'/sections/requests/new.php');
			break;
		case 'vote':
			include(SERVER_ROOT.'/sections/requests/vote.php');
			break;
			break;
		case 'fill':
			include(SERVER_ROOT.'/sections/requests/fill.php');
			break;
		case 'takerequest':
			include(SERVER_ROOT.'/sections/requests/takerequest.php');
			break;
		case 'takeedit':
			include(SERVER_ROOT.'/sections/requests/takeedit.php');
			break;
		case 'unfill':
		...
		case 'reply':
			...
			header('Location: requests.php?action=viewrequest&id='.$RequestID.'&page='.$Pages);
		break;
