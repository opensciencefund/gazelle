...
<h2 class="center">Ratio Rules</h2>
	<div class="box pad">
		...
		<p>
			To maintain an account on the site, we require that you maintain a ratio above a minimum ratio. This is called your "required ratio". If your upload/download ratio goes below your required ratio, your account will be given a two week period to fix it before it is disabled. This is called "ratio watch". 
		</p>
		...
		<table>
			...
			<tr class="row<?=($LoggedUser['BytesDownloaded'] > 50*1024*1024*1024 && $LoggedUser['BytesDownloaded'] < 100*1024*1024*1024)?'a':'b'?>">
				<td>80-100GB</td>
				<td>0.60</td>
				<td>0.50</td>
			</tr>
		...
		<p>
			If your ratio does not meet your required ratio, you will be put on ratio watch. You will have <strong>two weeks</strong> to get your ratio above your required ratio - <strong>failure to do so will result in your account being automatically disabled</strong>. 
		</p>
		...
		<p>
			The ratio watch system is completely automatic, and cannot be altered by staff. However, <b>after your account has been disabled</b> by ratio watch, you are welcome to talk to a staff member on IRC and ask for a <strong>second chance</strong>. 
		</p>
