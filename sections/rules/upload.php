...
<!-- Actual Uploading Rules -->	
	...
	<h2 id="h1"><a href="#h1k"><strong>&uarr;</strong></a> 1. Uploading Rules</h2>
	
	<h3 id="h1.1"><a href="#h1.1k"><strong>&uarr;</strong></a> 1.1. General</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r1.1.1"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.1. <strong>Only music, applications, comic books, eBooks, comedy (audio), audiobooks, and eLearning videos are allowed here.</strong>

			</li>
			<li id="r1.1.2"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.2. <strong>Duplicate torrents in any category are not allowed.</strong> There are some exceptions to this rule, which are outlined in their relevant sections below.
			</li>
			<li id="r1.1.3"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.3. <strong>No freely available content in non-music sections.</strong> If you could just download from the web, so can everyone else. Each main section explains in greater detail what "freely available" means in context. <a href="#r2.1.9">See 2.1.9</a> in regards to freely available music.
			</li>

			<li id="r1.1.4"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.4. <strong>Seed complete copies.</strong> Do not upload a torrent unless you intend to seed until there are at least 1.0 distributed copies. Seeding past this minimum is strongly encouraged.
			</li>
			<li id="r1.1.5"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.5. <strong>No advertisements.</strong> Do not advertise other sites in your torrent descriptions, torrent directories, or the contents of your torrent. We have no advertising and neither should you. <u>Exceptions</u>: Additional information about an artist, album, or band is acceptable, and does not count as advertising.
			</li>

			<li id="r1.1.6"><a href="#h1.1"><strong>&uarr;_</strong></a> 1.1.6. <strong>Archived files in uploads are not allowed.</strong> <u>Exceptions</u>: The sections that allow archived files (e.g. zip, rar, iso, etc.) are the following:
				<ul>
	...
	<h3 id="h1.2"><a href="#h1.2k"><strong>&uarr;</strong></a> 1.2. Specifically Banned</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r1.2.1"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.1. <strong>Anything not specifically allowed below.</strong> If you have any doubts, ask before uploading.
			</li>

			<li id="r1.2.2"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.2. <strong>Any car parts and car data programs.</strong> This ban includes programs like AllData and vendor-specific diagnostic programs such as Carsoft.
			</li>
			<li id="r1.2.3"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.3. <strong>Videos of any kind (other than eLearning Videos).</strong> No movies, no TV shows, no concerts, and no data/video tracks from enhanced CDs.
			</li>
			<li id="r1.2.4"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.4. <strong>Pornography or nudity of any kind.</strong> This ban includes pictures, erotic comic books or hentai, sex manuals, erotic magazines, etc.
			</li>

			<li id="r1.2.5"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.5. <strong>Games of any kind.</strong> No games of any kind are allowed: whether PC, Mac, phone or any other platform.
			</li>
			<li id="r1.2.6"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.6. <strong>Collections of pictures or wallpapers are not applications.</strong> You may not upload them to any category.
			</li>
			<li id="r1.2.7"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.7. <strong>User compilations in any category.</strong> All "packs" must be reasonably official as specified in each category.
			</li>

			<li id="r1.2.8"><a href="#h1.2"><strong>&uarr;_</strong></a> 1.2.8. <strong>DRM-restricted files:</strong> files must not be encrypted or in a restricted format that impedes sharing. It is also highly encouraged that you remove personal information from non-DRM protected files (such as iTunes Plus releases).
			</li>
		</ul>
	</div>
	
	<h3 id="h1.3"><a href="#h1.3k"><strong>&uarr;</strong></a> 1.3. Scene Uploads</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">

		<ul>
			<li id="r1.3.1"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.1. <strong>Do not add irrelevant credits to your torrent.</strong> Your name is credited to the upload, and there's no need to plaster it all over the place!
			</li>
			<li id="r1.3.2"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.2. <strong>You may give credit to the release group (optional).</strong> If you really want to give credit to the release group, mention the full release name, including group name in the <em>Release description</em> section.
			</li>

			<li id="r1.3.3"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.3. <strong>No NFO art pasted in the album description.</strong> Unedited NFOs are allowed within the specific <em>Release description</em>&ndash;not the <em>Album description</em>. If you must include some information from the NFO in the <em>Album description</em> or torrent description, include only the tracklist, album notes, and other essential information. Specific encoding settings belong in the <em>Release description</em>.
			</li>

			<li id="r1.3.4"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.4. <strong>Use the correct actual album title on the <a href="upload.php">upload page</a>; do not use the scene-given title.</strong> Naming your <em>albums_titles_like_this</em> or <em>your.albums.like.this</em> is not allowed. Use the actual release title and artist. Do not use the title from the folder or NFO of the scene release.
			</li>
			<li id="r1.3.5"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.5. <strong>Scene releases must be complete (as released) to use the scene label.</strong> If you've changed the tags, unpacked the archive, removed any files, split the tracks, or altered the naming, then it is no longer a scene release. It should not be labeled as such.
			</li>

			<li id="r1.3.6"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.6. <strong>No protected archives.</strong> Archived releases must not be password protected.
			</li>
			<li id="r1.3.7"><a href="#h1.3"><strong>&uarr;_</strong></a> 1.3.7. <strong>Scene releases must conform to rules specified for their respective section.</strong> For example, music scene releases must adhere to the music quality and formatting rules no matter how the original files were released. If the scene archives were password protected, you cannot upload them to this site unmodified. <u>Exceptions:</u> You may upload scene releases that originally do not fit in the rules if you can make the necessary changes within the rules. However, these modified uploads must not be labeled as "scene."
			</li>

		</ul>
	</div>
	
	<h2 id="h2"><a href="#h2k"><strong>&uarr;</strong></a> 2. Music</h2>
	
	<h3 id="h2.1"><a href="#h2.1k"><strong>&uarr;</strong></a> 2.1. General</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r2.1.1"><a href="#h2.1"><strong>&uarr;_</strong></a> 2.1.1. <strong>The only formats allowed for music are those listed below:</strong>
	...
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			...
			<li id="r4.2.2"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.2. <strong>0-Day comic packs are allowed.</strong> Make sure such uploads are synchronized with previous packs. 0-Day comic uploads must not be missing any of their corresponding DCP or Minutemen scans for that sync time.
			</li>

			<li id="r4.2.3"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.3. <strong>Collections may not span more than one comic title.</strong> You may not collect multiple different comic titles. e.g. "The Amazing Spider-Man #1 and The Incredible Hulk #1" <u>Exceptions:</u> Titles may contain more than one comic title if either: it's a recognized comic crossover/event or it's a DCP weekly release.
			</li>
			<li id="r4.2.4"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.4. <strong>Any "multi-part" comic enveloping the whole event is allowed as a single torrent.</strong> Whole events may be uploaded together. For example, the comics "Buffy the Vampire Slayer Season Eight - 2007 - part 1.cbr" and "Buffy the Vampire Slayer Season Eight - 2007 - The Long Way Home Part 2.cbr" can be uploaded as a single torrent providing there are only 2 parts to "The Long Way Home."
			</li>

			<li id="r4.2.5"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.5. <strong>Torrents containing complete volumes of comics may be uploaded.</strong> For example, "The Amazing Spider-Man Vol. 1 #1-#441" can be uploaded.
			</li>
			<li id="r4.2.6"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.6. <strong>Torrents spanning multiple volumes are too large and must be uploaded as separate volumes.</strong>
			</li>
			<li id="r4.2.7"><a href="#h4.2"><strong>&uarr;_</strong></a> 4.2.7. <strong>Torrents containing #Number-#CurrentDay are allowed only if the comics appear in no other pack.</strong> Take for instance, if #1-#35 are already on site and the current issue is #50, #1-#50 is NOT allowed to be uploaded, but #36-#50 is allowed.
			</li>

		</ul>
	</div>
	
	<h3 id="h4.3"><a href="#h4.3k"><strong>&uarr;</strong></a> 4.3. Duplicates &amp; Trumping</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r4.3.1"><a href="#h4.3"><strong>&uarr;_</strong></a> 4.3.1. <strong>A dupe of a single comic is defined as two scans of the same book by the same scanner, where the same pages have been scanned.</strong> <u>Exceptions:</u> The following examples are NOT dupes: 
				<ul>
			...
			<li id="r4.3.2"><a href="#h4.3"><strong>&uarr;_</strong></a> 4.3.2. <strong>Releases in .cbz and .cbr are always allowed, with preference given to the earliest upload.</strong> In the event of a dupe occurring between a .cbr and a .cbz, the earliest upload remains. In the event of any other dupe, the order listed in 4.1.1 determines which torrent is kept regardless of uploaded time. e.g. A PDF is uploaded followed by a .cbr, the .cbr remains on site and the PDF is deleted as a dupe.
			</li>

			<li id="r4.3.3"><a href="#h4.3"><strong>&uarr;_</strong></a> 4.3.3. <strong>Multi-comic collections and packs must follow either of these collection types in order of preference.</strong> For example, there is the torrent #1-50 on site, the only pack containing any of the comics before #50 that are allowed to be uploaded are a #1-100 pack or a complete volume pack.
				<ul>
	...
	<h3 id="h4.4"><a href="#h4.4k"><strong>&uarr;</strong></a> 4.4. Formatting</h3>
	<div class="box pad" style="padding:10px 10px 10px 20px;">

		<ul>
			<li id="r4.4.1"><a href="#h4.4"><strong>&uarr;_</strong></a> 4.4.1. <strong>All comic page scans must be zero-padded numbered and may be archived properly in .pdf, .rar (.cbr) or .zip (.cbz).</strong> The contents of the archive or directory must be image files (either JPEG or PNG) named sequentially for display in the correct order by <a href="http://www.zcultfm.com/~comic/wiki/index.php/Comic_Viewers">comic reading software</a> such as <a href="http://www.geocities.com/davidayton/CDisplay.html">CDisplay</a> and <a href="http://www.feedface.com/software/ffview.html">FFView</a>. The page numbers and books must be zero-padded for this same reason. <em>For example, Good numbering: file01.jpg, file02.jpg .. file30.jpg and Bad numbering: file1.jpg, file2.jpg, file3.jpg...file30.jpg.</em>

			</li>
			<li id="r4.4.2"><a href="#h4.4"><strong>&uarr;_</strong></a> 4.4.2. <strong>Comic book archive file names must be informative.</strong> The archive names should include at least the Book's name (i.e. Uncanny X-Men), the volume (if there's more than one volume of that book) and the issue number. It is recommended to also include the cover year and the scanner information (to differentiate between different scans of the same book), as well as the issue's title (i.e. Days of Future Past). For example: <em>Buffy the Vampire Slayer Season Eight - #01 - 2007 - The Long Way Home Part 1.cbr</em> and <em>Amazing Spiderman - Volume 1 - #10 - 1964.cbz</em>
			</li>
			<li id="r4.4.3"><a href="#h4.4"><strong>&uarr;_</strong></a> 4.4.3. <strong>The directory name should uniquely identify its contents.</strong> You should include the title, as well as the issue numbers included (if applicable). The title, volume, cover year, and story name can often be found in small type at the bottom of the page opposite the inside cover. Directories should be named with the title of the series and the issue numbers. For example: <em>../Buffy the Vampire Slayer Season Eight - #01-#08/</em> and <em>../Amazing Spiderman - Volume 1 - #10-#20/</em>

			</li>
		</ul>
	</div>

	<h2 id="h5"><a href="#h5k"><strong>&uarr;</strong></a> 5. eBooks, eLearning Books &amp; Sheet Music</h2>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>

			<li id="r5.1"><a href="#h5"><strong>&uarr;_</strong></a> 5.1. <strong>Individual releases can be either a torrent of a directory, an archive or original format (e.g. .chm, .pdf, .txt, etc.).</strong> Neither the individual release or archive can be password protected.
			</li>			
			<li id="r5.2"><a href="#h5"><strong>&uarr;_</strong></a> 5.2. <strong>Do not archive collections into a single archive (.zip, .tar, .rar, etc.).</strong> You may individually archive each release separately if you want to compress the files. Uploading a pack of eBooks in one archive (e.g. .tar, .rar, .zip) is prohibited.
			</li>
			<li id="r5.3"><a href="#h5"><strong>&uarr;_</strong></a> 5.3. <strong>Only published eBooks are allowed.</strong> Freely available unofficial eBooks are not allowed. This rule also covers recipes and cookbooks: only official publications are allowed.
			</li>

			<li id="r5.4"><a href="#h5"><strong>&uarr;_</strong></a> 5.4. <strong>Collections of eBooks are allowed if each title is related to each other in a meaningful way.</strong> Releases of similar topic can be uploaded in a collection. You may not upload a collection of eBooks with nothing in common other than made by a single publisher (e.g. O'Reilly). Nor does it mean you can group eBooks by a broad area of topic. For example, "50 books in English," "Psychology books," or "Electrical engineering pack." Your collection must focus on a specific topic, series, or a body of work by an author.
			</li>
			<li id="r5.5"><a href="#h5"><strong>&uarr;_</strong></a> 5.5. <strong>Identical eBooks and identical sheet music uploads are dupes respectively.</strong> The same eBook and sheet music titles in the same format (e.g. .pdf, .chm, .txt, etc.) are dupes. <u>Exceptions</u>: eBooks and sheet music uploaded individually are not dupes if the same eBooks or sheet music releases are part of a torrent that consists of a collection.
			</li>

			<li id="r5.6"><a href="#h5"><strong>&uarr;_</strong></a> 5.6. <strong>Include proper <a href="rules.php?p=tag">Gazelle tags</a> for your eBook and sheet music uploads.</strong> You are strongly encouraged to use the appropriate default tags with your uploads. That way other users can find your uploads easily through the tag search system. Sheet music should use the sheet.music tag. eBooks should at least contain the tag ebooks.fiction or ebooks.non.fiction depending on the contents. You may add additional tags if the defaults do not apply or are not enough to describe the torrent contents.
			</li>
		</ul>
	</div>
	
	<h2 id="h6"><a href="#h6k"><strong>&uarr;</strong></a> 6. Comedy (Audio) &amp; Audio Books</h2>

	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r6.1"><a href="#h6"><strong>&uarr;_</strong></a> 6.1. <strong>The only formats allowed for comedy and audio books are those listed below:</strong>
				<ul>
					<li>MP3, FLAC, Ogg Vorbis, AAC, AC3, DTS</li>
				</ul>
			...
			<li id="r6.2"><a href="#h6"><strong>&uarr;_</strong></a> 6.2. <strong>No music is permitted in these two categories.</strong> They are for spoken word only.
			</li>
			<li id="r6.3"><a href="#h6"><strong>&uarr;_</strong></a> 6.3. <strong>No radio talk shows and podcasts are allowed.</strong> What.CD is primarily a music site, and those do not belong in any torrent categories.
			</li>

			<li id="r6.4"><a href="#h6"><strong>&uarr;_</strong></a> 6.4. <strong>Comedy and audio books must not be freely available.</strong> Free audio books and comedy releases from official sources may not be uploaded. <u>Exceptions</u>: Uploads that are at a different bitrate from those freely available are allowed. If a comedy album in 96kbps CBR MP3 is freely available, you may still upload a -V8 (VBR) or higher bitrate torrent of the freely available torrent if it does not exist on the site already.
			</li>
			<li id="r6.5"><a href="#h6"><strong>&uarr;_</strong></a> 6.5. <strong>Releases must be unarchived and of a single release.</strong> Comedy and audio book releases should not be archived in a file, such as .zip or .rar. Releases must be a torrent of a directory containing the audio files. Only one torrent per release. You may not bundle multiple audio books or comedy releases in one torrent. <a href="#r1.2.7">See 1.2.7.</a>

			</li>
			<li id="r6.6"><a href="#h6"><strong>&uarr;_</strong></a> 6.6. <strong>All comedy and audio book releases must at least have an average bitrate of 16kbps mono or 32kbps stereo.</strong> Higher bitrates are preferred over this minimum, however.
			</li>
			<li id="r6.7"><a href="#h6"><strong>&uarr;_</strong></a> 6.7. <strong>Lossy sources, including lossy transcodes, are allowed in this section only.</strong> Lossy-sourced audio is permitted only in the comedy and audio book categories. This means the source may come from cassette, VHS (audio), radio, or a higher bitrate lossy file. While the sharing of transcoded material is strongly discouraged for music, the audio quality is less important for spoken word material. You may not transcode a lower bitrate file to a higher bitrate file and upload here. For example, you find a 32kbps CBR WMA and transcode it to 64kbps CBR MP3.
			</li>

			<li id="r6.8"><a href="#h6"><strong>&uarr;_</strong></a> 6.8. <strong>Duplicate torrents of the same bitrate and format are not allowed.</strong> No uploads of the same bitrate and format are allowed to coexist on the site. For example, if a torrent exists on the site in 256kbps MP3, no further torrents in 256kbps MP3 are allowed. Significantly higher or lower bitrate rips or different file formats of the same content are allowed. <u>Exceptions</u>: One LAME -V8 (or -V8 --vbr-new [with or without -mm]) rip is allowed on the site at any time. Even if a 85kbps CBR rip is already on the site, you may still upload a -V8 (VBR). The -V8 (VBR) may be sourced from a higher bitrate lossy encoded file.
			</li>
			<li id="r6.9"><a href="#h6"><strong>&uarr;_</strong></a> 6.9. <strong>Scene and non-scene releases of the same release, bitrate, and format are dupes.</strong> The "scene" label does not make torrents unique from each other. If a -V2 (VBR) of an album in CD is already uploaded, you may not upload a -V2 (VBR) scene version of the same album in CD.
			</li>

			<li id="r6.10"><a href="#h6"><strong>&uarr;_</strong></a> 6.10. <strong>Releases must follow formatting guidelines for file names and tags.</strong> Audiobooks and comedy must follow formatting rules outlined in section 2.3. This means no file names without track numbers, no files without metatags, and so forth. For comedy, at least use <a href="rules.php?p=tag">the official Gazelle tag</a> of "comedy". And for audio books, at least use the <a href="rules.php?p=tag">Gazelle tag</a> of "audio.books".
			</li>
		</ul>
	</div>

	
	<h2 id="h7"><a href="#h7k"><strong>&uarr;</strong></a> 7. eLearning Videos</h2>
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			<li id="r7.1"><a href="#h7"><strong>&uarr;_</strong></a> 7.1. <strong>The eLearning Videos category is for tutorial videos of specific topics only.</strong> Any video clips mentioned in <a href="#h1.2">Section 1.2.</a> cannot be uploaded to the eLearning Videos category. 
			</li>

			<li id="r7.2"><a href="#h7"><strong>&uarr;_</strong></a> 7.2. <strong>No freely available eLearning videos</strong> You may not upload videos hosted officially from university sites, the author's site, the <a href="http://www.archive.org/index.php">Internet Archive</a> or publisher's site. You may upload videos from other torrent sites provided they conform to the rules in this section.
			</li>
			<li id="r7.3"><a href="#h7"><strong>&uarr;_</strong></a> 7.3. <strong>Tutorials on how to use features of applications, musical instruments or computer hardware are the only allowed topics.</strong> No material outside of these 3 topics are allowed. For example, instruction videos about Kung Fu training, dance lessons, or beer brewing are not permitted here.
			</li>

			<li id="r7.4"><a href="#h7"><strong>&uarr;_</strong></a> 7.4. <strong>eLearning Videos must be either in a video file format (.avi, .mov, etc.) or a disk image (.iso, .bin/.cue, etc.).</strong> <u>Exceptions</u>: Only scene uploads may be archived into compressed archives (zip, rar, etc.).
			</li>
			<li id="r7.5"><a href="#h7"><strong>&uarr;_</strong></a> 7.5. <strong>eLearning video uploads must contain an informative description and use proper <a href="rules.php?p=tag">Gazelle tags</a>.</strong> Uploads should include a proper description and/or a link to further information. It is strongly encouraged they at least have the elearning.videos <a href="rules.php?p=tag">Gazelle tag</a> as well.
			</li>
