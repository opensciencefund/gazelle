...
$Types = array(
			"user" => array(
						"title" => "User",
						"guidelines" => array("The Report User option is for reporting a user who has broken one of the golden rules outlined <a href=\"rules.php\">here</a>, or if you need to alert staff to something specific about a user that cannot be reported elsewhere.",
			...
			"request" => array(
						"title" => "Request",
						"guidelines" => array("The report request option is for reporting a request which breaks any of the rules found here.",
											"We encourage all users to use this feature whenever possible. This will get quicker action than PMing a staff member will.",
												"In your report description below, please be specific and include as much information as possible that will help our staff resolve the issue."
						)
					),
			"requests_comment" => array(
						...
						"guidelines" => array("The Report comment option is specifically for reporting when the Chat Rules have been broken.",
			...
			"thread" => array(
						"title" => "Forum Thread",
						"guidelines" => array("The Report Thread option is specifically for reporting when the Chat Rules have been broken. Such as posts containing racism, offensive language, flaming, pornography, and other rules violations. We encourage all users to use this feature when they see a rules violation of any form.",
											"This will get quicker action than PMing a staff member will.",
			...
			"collage" => array(
						"title" => "Collage",
						"guidelines" => array("The report collage option is for reporting a collage which breaks one of the collage guidelines found on the collage rules page: rules.php?p=collages",
