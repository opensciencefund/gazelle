...
?>
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="artistname" class="inputtext smaller" value="<?form('artistname')?>" />
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="groupname" class="inputtext smaller" value="<?form('groupname')?>" />
				</td>
			</tr>
			<tr>
				<td class="label">Record Label:</td>
				<td colspan="3">
					<input type="text" size="40" name="recordlabel" class="inputtext smaller" value="<?form('recordlabel')?>" />
				</td>
			</tr>
			<tr>
...
?>
			<tr id="edition_title" class="<?=$Hidden?>">
				...
				<td>
					<input type="text" size="40" name="remastertitle" class="inputtext smaller" value="<?form('remastertitle')?>" />
				</td>
			...
			<tr id="edition_label" class="<?=$Hidden?>">
				...
				<td colspan="3">
					<input type="text" size="40" name="remasterrecordlabel" class="inputtext smaller" value="<?form('remasterrecordlabel')?>" />
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="filelist" class="inputtext" value="<?form('filelist')?>" />
				</td>
			</tr>
			<tr>
...
<? } else { // BASIC SEARCH ?>
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="searchstr" class="inputtext" value="<?form('searchstr')?>" />
...
<?		
		...
		foreach($Torrents as $TorrentID => $Data) {
			...
			if(isset($_GET['haslog']) && $_GET['haslog']!=='') {
				...
				if(($_GET['haslog'] == '1' || $_GET['haslog'] == '0') && $Data['HasLog']==$_GET['haslog']) {
					$Pass = true;
				}
			}
