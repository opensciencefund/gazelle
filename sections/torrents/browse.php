...
?>
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="artistname" class="inputtext smaller" value="<?=display_str($_GET['artistname'])?>" />&nbsp;
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="torrentname" class="inputtext smaller" value="<?=display_str($_GET['torrentname'])?>" />&nbsp;
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="remastertitle" class="inputtext smaller" value="<?=display_str($_GET['remastertitle'])?>" />&nbsp;
			...
			<tr>
				...
				<td colspan="3"><input type="text" size="40" name="filelist" class="inputtext" value="<?=display_str($_GET['filelist']); ?>" /></td>
			</tr>
			<tr>
...
<?	} ?>			</select>
					...
					<span id="other_bitrate_span"<? if(!$OtherBitrate){ echo " style='display: none;'"; } ?> >
						<input type="text" name="other_bitrate" size="5" id="other_bitrate"<? if($OtherBitrate){ echo " value='".display_str($_GET['other_bitrate'])."'";} ?> />
					</span>
...
<? } else { ?>
			<tr>
				...
				<td colspan="3">
					<input type="text" size="40" name="searchstr" class="inputtext" value="<?=display_str($_GET['searchstr'])?>" />
